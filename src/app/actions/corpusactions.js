...
const CorpusActions = function(){
    ...
    var ExamineTopics = {
        ...
        ExamineThisText: function($parent_li, params, custom_callback, no_msg){
            var self = this,
                callback = custom_callback || this.BuildTfIdfTable.bind(this),
                params = params || {
                    action:"examine_text",
            ...
            //TODO: stupid reference to upper scope?
            picked_code = params.picked_code;
        ...
        BuildTfIdfTable: function(data){
                    ...
                    //TODO: setting picked_code is not done robustly, fix it
